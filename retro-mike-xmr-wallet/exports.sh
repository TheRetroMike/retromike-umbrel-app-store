...
if [ ! -f /home/umbrel/umbrel/app-data/retro-mike-xmr-wallet/.monero/default.keys ]; then
    ...
    echo "1" | ./monero-wallet-cli --password poolpassword --use-english-language-names --generate-new-wallet /home/umbrel/umbrel/retro-mike-xmr-wallet/.monero/default 2>/dev/null
fi